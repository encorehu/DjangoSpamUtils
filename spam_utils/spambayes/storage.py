...
Classes:
    ...
    PG2Classifier - Classifier that uses postgres, psycopg2
...
import types
import tempfile
from spam_utils.spambayes import classifier
from spam_utils.spambayes.Options import options, get_pathname_option
import errno
import shelve
from spam_utils.spambayes import cdb
from spam_utils.spambayes import dbmstorage
from spam_utils.spambayes.safepickle import pickle_write, pickle_read
...
class PGClassifier(SQLClassifier):
    '''Classifier object persisted in a Postgres database via psycopg'''
    def __init__(self, db_name):
...
class PG2Classifier(SQLClassifier):
    '''Classifier object persisted in a Postgres database via psycopg2'''
    def __init__(self, db_name, db_user=None, db_password=None, db_host=None, db_port=None):
    ...
    def cursor(self):
        ...
        return self.db.cursor(cursor_factory=DictCursor)
